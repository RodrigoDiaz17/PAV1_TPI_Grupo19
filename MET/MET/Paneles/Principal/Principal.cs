...
namespace MET.Paneles
{
    public partial class Principal : AbstractForm
    {
        ...
        private readonly Publicador publicadorTema = new Publicador();
        private int pw;
        private bool hide;
...
//TEMAS
        ...
        {
            //paneles
            panelTemas.BackColor = Colors[0];
            panelSettings.BackColor = Colors[0];
            //BotonesSobre
            btnTemas.FlatAppearance.MouseOverBackColor = Colors[1];
            btnTemaOscuro.FlatAppearance.MouseOverBackColor = Colors[1];
            btnTemaPlateado.FlatAppearance.MouseOverBackColor = Colors[1];
            //MouseDown
